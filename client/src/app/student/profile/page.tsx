      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="bg-slate-900/50 border border-white/5 p-10 rounded-2xl backdrop-blur-sm">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            {/* Avatar */}
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 
            ...
            <div>
              ...
              <p className="inline-block mt-4 px-4 py-1 text-sm rounded-full 
                bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 font-medium flex items-center gap-2">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                focus:ring-indigo-500/20 transition rounded-xl w-full p-3 text-white placeholder:text-slate-500"
                value={oldPassword}
            ...
            <div>
              ...
              <input
                ...
                className="bg-slate-800/50 border border-white/10 focus:border-purple-500 focus:ring-2
                focus:ring-purple-500/20 transition rounded-xl w-full p-3 text-white placeholder:text-slate-500"
                value={newPassword}
            ...
            <button
              ...
              hover:from-indigo-500 hover:to-purple-500 transition text-white font-semibold shadow-lg text-lg"
            >
              Mettre à jour
            </button>
