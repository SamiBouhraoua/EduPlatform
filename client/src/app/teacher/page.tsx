...
import { BookOpen, Users, FileText, TrendingUp, Award, ArrowRight, User } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="relative rounded-2xl p-10 overflow-hidden border border-white/10 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 backdrop-blur-xl">
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-lg text-indigo-200">
                Portail Enseignant • {new Date().toLocaleDateString('fr-FR', { weekday: 'long', day: 'numeric', month: 'long' })}
              </p>
            </div>
          ...
          <p className="max-w-2xl text-slate-300 leading-relaxed">
            Gérez vos cours, suivez vos étudiants et partagez vos ressources pédagogiques.
          </p>
        </div>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-white font-medium italic leading-relaxed">
                "Un bon enseignant peut inspirer l'espoir, enflammer l'imagination et inculquer l'amour de l'apprentissage."
              </p>
              <p className="text-xs text-slate-500 mt-2">— Brad Henry</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-slate-900/50 border border-white/5 p-8 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Enseignement</h3>
            <p className="text-slate-300 leading-relaxed">
              Vous enseignez <strong className="text-white">{stats.courses}</strong> cours
              à <strong className="text-white">{stats.students}</strong> étudiants cette session.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              ont été partagés avec vos étudiants.
            </p>
          </div>
        </div>
      </div>
